<template>
  <div class="w-screen flex">
    ...
    <path d="M9 17.25C8.58579 17.25 8.25 17.5858 8.25 18C8.25 18.4142 8.58579 18.75 9 18.75H15C15.4142 18.75 15.75 18.4142 15.75 18C15.75 17.5858 15.4142 17.25 15 17.25H9Z" fill="#1C274C"/>
        ...
        <li>
          <router-link to="all_question" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
  ...
  <div class="px-6 py-4 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
          <img src="../../assets/logo.webp" class="h-8 me-3" alt="logo" />
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="#" @submit.prevent="login">
                    <div>
                        <label for="email"  style="margin-right: 80%;" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                    ...
                    <div>
                        <label for="password"  style="margin-right: 80%;" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
  ...
  methods: {
    async login() {
      try {
        ...
        // fermer le modal qunad on se connecte et rechatger la page 
